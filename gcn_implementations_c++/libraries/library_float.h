...
void updateWeightsAdam(int32_t s1, int32_t t, float lr, float beta1, float beta2, float eps, vector<FPArray>& inArr, vector<FPArray>& derArr) ;

void updateWeights2Adam(int32_t s1, int32_t s2, int32_t t, float lr, float beta1, float beta2, float eps, vector<vector<FPArray>>& inArr, vector<vector<FPArray>>& derArr) ;
