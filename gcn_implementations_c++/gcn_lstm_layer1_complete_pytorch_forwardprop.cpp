...
/*cout<<endl;
for(uint32_t ind=0;ind<1989;ind++)
cout<<finaloutput[0][ind]<<" ";
cout<<endl;*/
}
...
AssignSampleFromData3D(d2, d3, 0, inp, inputpoint);
...
/*
for(uint32_t iterations=0; iterations<1000; iterations++)
{
