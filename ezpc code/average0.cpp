...
auto grid1 = make_vector<Integer>( (int32_t)2);
if ((party == BOB)) {
...
auto bool1 = make_vector<Bit>( (int32_t)2);
if ((party == BOB)) {
...
auto grid2 = make_vector<Integer>( (int32_t)2);
if ((party == ALICE)) {
...
auto bool2 = make_vector<Bit>( (int32_t)2);
if ((party == ALICE)) {
...
auto grid = make_vector<Integer>( (int32_t)2);
for (uint32_t i =  (int32_t)0; i <  (int32_t)2; i++){
...
auto clientbool = make_vector<Bit>( (int32_t)2);
